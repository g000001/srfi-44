...
(define-supertype-handled flexible-sequence?
  ...
  ((flexible-sequence-set! fseq k value)
   sequence-set!)
  ((flexible-sequence-insert-left fseq value)
...
(defmethod flexible-sequence-delete-right! ((fseq cl:sequence))
  (let ((elt (car (last fseq))))
    (rplacd (last fseq 2) nil)
    (values fseq elt)))

(defgeneric flexible-sequence-delete-right (fseq))
(defmethod flexible-sequence-delete-right (fseq)
  (flexible-sequence-delete-right! (flexible-sequence-copy fseq)))
